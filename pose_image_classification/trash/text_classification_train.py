...
import os
import json
model_ckpt = "static/distilbert-base-uncased" # or path of the model for in local storage
tokenizer = AutoTokenizer.from_pretrained(model_ckpt)
model_ckpt = "static/distilbert-base-uncased"
...
def text_train(dataset_path):
    ...
    print(str_elements)
    with open('static/train_text_classes.json', 'w') as f:
    ...
    os.system(f'rm -r static/text_classification_model')
    ...
    trainer.save_model("static/text_classification_model")
