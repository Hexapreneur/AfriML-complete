...
const phrases = {
  Games: "African Games match.",
  Sculptures: "African sculpture match.",
  Fabric: "African fabric match.",
  Jewelries: "African jewelry match.",
  Tools: "African tools match."
};

const getPhrase = (predictedClass) => {
...
const PreviewCard = ({
  ...
  //const phrase = getPhrase(predictions.predictedClass);
