...
const Image = () => {
  ...
  const trainingHandler = async () => {
    ...
    try {
      ...
      setError("");
      setIsLoading(true);
      const createUrl = process.env.VITE_APP_CREATE_URL;
      const uploadUrl = process.env.VITE_APP_UPLOAD_URL;
      const trainUrl = process.env.VITE_APP_PROCESS_URL;
  ...
  const handleAdvancedTest = async () => {
    const advancedTestUrl = process.env.REACT_APP_EXPORT_URL;
